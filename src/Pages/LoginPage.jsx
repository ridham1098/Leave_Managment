      ...
      >
        <div className="flex justify-center mb-6">
          <img
            src={Logo}
            alt="logo"
            className="w-24 h-24 rounded-3xl bg-white p-2 shadow-2xl border border-white/30 hover:scale-105 transition duration-300"
          />
        </div>
        ...
        <form
          ...
          className="bg-white/10 backdrop-blur-xl border border-red-400/30 rounded-2xl p-8 shadow-2xl space-y-5"
        >
